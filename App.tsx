...
const App: React.FC = () => {
  ...
  return (
    // CAMBIO IMPORTANTE AQUÍ: Agregamos soporte para modo claro (bg-slate-50) y oscuro (dark:bg-slate-900)
    <main className="h-screen w-screen font-sans transition-colors duration-300 bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100">
      {renderContent()}
